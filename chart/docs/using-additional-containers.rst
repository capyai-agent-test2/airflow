...
You can define different containers for the scheduler, api-server, Kubernetes/Celery workers, triggerer, dag processor, flower, create user job, create pool job and migrate database job pods.
...
You can define different containers for the scheduler, api-server, Celery/Kubernetes workers, triggerer, dag processor, create user job, create pool job and migrate database job pods.
