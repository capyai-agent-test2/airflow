...
def get_optional_cross_provider_dependent_packages(provider_id: str) -> list[str]:
    required_packages = {
        PipRequirements.from_requirement(requirement).package.split("[", maxsplit=1)[0]
    ...
    return [
        ...
        and get_pip_package_name(cross_provider_id) not in required_packages
    ]
...
def get_provider_jinja_context(
    ...
    cross_providers_dependencies = get_optional_cross_provider_dependent_packages(provider_id=provider_id)
