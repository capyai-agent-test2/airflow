...
class SkipMixin(LoggingMixin):
    ...
    def _set_state_to_skipped(
        ...
        # Only for non-mapped tasks — future mapped tasks have not been expanded yet
    ...
    def skip(
        ...
        If this instance has a ``task_id`` attribute, stores skipped task IDs to XCom
        so that NotPreviouslySkippedDep knows these tasks should be skipped when cleared.
        """
