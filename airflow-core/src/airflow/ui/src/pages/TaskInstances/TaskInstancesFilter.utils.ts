...
import type { FilterableSearchParamsKeys } from "src/utils";
...
export const getTaskInstancesFilterKeys = ({
  dagId,
  runId,
  taskId,
}: {
  ...
  const paramKeys: Array<FilterableSearchParamsKeys> = [
    ...
    ...(taskId === undefined ? [RENDERED_MAP_INDEX_PARAM as FilterableSearchParamsKeys] : []),
