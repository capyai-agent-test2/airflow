...
type ImportErrorsValue = "all" | "false" | "true";

type Props = {
  readonly onChange: (value: ImportErrorsValue) => void;
  readonly value: ImportErrorsValue;
};

export const ImportErrorsFilter = ({ onChange, value }: Props) => {
