...
* @throws ApiError
*/
export const ensureUseGridServiceGetGridRunsData = (queryClient: QueryClient, { bundleVersion, confContains, consumingAssetPattern, dagId, dagVersion, durationGt, durationGte, durationLt, durationLte, endDateGt, endDateGte, endDateLt, endDateLte, limit, logicalDateGt, logicalDateGte, logicalDateLt, logicalDateLte, offset, orderBy, runAfterGt, runAfterGte, runAfterLt, runAfterLte, runType, startDateGt, startDateGte, startDateLt, startDateLte, state, triggeringUser, triggeringUserPrefix }: {
  bundleVersion?: string;
  confContains?: string;
  consumingAssetPattern?: string;
  dagId: string;
  ...
  triggeringUser?: string;
  triggeringUserPrefix?: string;
}) => queryClient.ensureQueryData({ queryKey: Common.UseGridServiceGetGridRunsKeyFn({ bundleVersion, confContains, consumingAssetPattern, dagId, dagVersion, durationGt, durationGte, durationLt, durationLte, endDateGt, endDateGte, endDateLt, endDateLte, limit, logicalDateGt, logicalDateGte, logicalDateLt, logicalDateLte, offset, orderBy, runAfterGt, runAfterGte, runAfterLt, runAfterLte, runType, startDateGt, startDateGte, startDateLt, startDateLte, state, triggeringUser, triggeringUserPrefix }), queryFn: () => GridService.getGridRuns({ bundleVersion, confContains, consumingAssetPattern, dagId, dagVersion, durationGt, durationGte, durationLt, durationLte, endDateGt, endDateGte, endDateLt, endDateLte, limit, logicalDateGt, logicalDateGte, logicalDateLt, logicalDateLte, offset, orderBy, runAfterGt, runAfterGte, runAfterLt, runAfterLte, runType, startDateGt, startDateGte, startDateLt, startDateLte, state, triggeringUser, triggeringUserPrefix }) });
/**
